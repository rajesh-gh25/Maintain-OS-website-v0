...
"[project]/components/ui/lottie-icon.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LottieIcon({ path, className }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch(path).then((response)=>response.json()).then((data)=>setAnimationData(data)).catch((error)=>console.error("Error loading animation:", error));
    }, [
        path
    ]);
...
//# sourceMappingURL=components_53804ce2._.js.map